...
The [native shell and conversation restyle](engineering/CONVERSATION_VIEW_RESTYLE.md) implements the prototype's portable visual mapping in the View layer. User visual acceptance is pending; other feature surfaces and presentation/runtime behavior remain outside this increment.
