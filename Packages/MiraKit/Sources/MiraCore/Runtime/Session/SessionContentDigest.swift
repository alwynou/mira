...
/// Portable SHA-256 used to bind effect receipts to canonical inline content.
enum SessionContentDigest {
    ...
    static func sha256(_ data: Data) -> String {
        ...
        for shift in stride(from: 56, through: 0, by: -8) {
            bytes.append(UInt8(truncatingIfNeeded: bitCount >> shift))
        }
        ...
        for offset in stride(from: 0, to: bytes.count, by: 64) {
            ...
            for index in 0..<64 {
                ...
                h = g; g = f; f = e; e = d &+ t1
                d = c; c = b; b = a; a = t1 &+ sum0 &+ majority
            }
            for (index, value) in [a, b, c, d, e, f, g, h].enumerated() { hash[index] = hash[index] &+ value }
        }
